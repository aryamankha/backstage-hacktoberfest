      ...
      <div className="flex flex-row justify-around">
        <div className="w-[444px] h-[1000px] bg-[#26282E] text-white text-left px-12 d flex flex-col">
          ...
          <div className="flex flex-col mt-16 text-left gap-4">
            ...
            <p>
              Here’s my bio! I’m really cool so buy my stuff. Lorem ipsum dolor
              sit amet, consectetur adipiscing elit. Praesent ipsum purus,
              pharetra nec lacus et, auctor finibus nisl. Etiam sollicitudin
              urna eu porttitor sagittis. Integer consequat lobortis cursus. Sed
              eu nisl sit amet erat ullamcorper convallis. Quisque pellentesque,
              dui vitae porta feugiat, lacus metus fermentum ante, a tincidunt
              mauris neque at metus.
            </p>
          </div>
        ...
        <div className="bg-white text-black w-3/4">
          <div className="flex flex-row justify-around py-4 border-b-2">
            <button className="text-xl border-b-8 border-b-[#485ED1]">
              My Story
            </button>
